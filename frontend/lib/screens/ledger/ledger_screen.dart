      ...
      body: ListView(
        ...
        children: [
          TextField(
            ...
            decoration: const InputDecoration(labelText: '金额', hintText: '¥ 0.00'),
          ),
          ...
          const SizedBox(height: 16),
          TextField(controller: noteController, decoration: const InputDecoration(labelText: '备注', hintText: '午餐 / 充值 / 周末采购')),
          const SizedBox(height: 16),
          Wrap(
            spacing: 8,
            runSpacing: 8,
            children: tags
                .map((tag) => FilterChip(label: Text(tag), selected: selectedTags.contains(tag), onSelected: (_) {
                      setState(() {
